...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_deity" AS ENUM('ganesha', 'shiva', 'krishna', 'lakshmi', 'hanuman', 'durga');
  CREATE TYPE "public"."enum_products_material" AS ENUM('brass', 'bronze', 'marble', 'resin', 'wood');
  CREATE TYPE "public"."enum_products_finish" AS ENUM('polished', 'antique', 'matte', 'gold-plated');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_version_deity" AS ENUM('ganesha', 'shiva', 'krishna', 'lakshmi', 'hanuman', 'durga');
  CREATE TYPE "public"."enum__products_v_version_material" AS ENUM('brass', 'bronze', 'marble', 'resin', 'wood');
  CREATE TYPE "public"."enum__products_v_version_finish" AS ENUM('polished', 'antique', 'matte', 'gold-plated');
  ...
  CREATE TABLE "products" (
  	...
  	"inventory_track_inventory" boolean DEFAULT true,
  	"seo_title" varchar,
  ...
  CREATE UNIQUE INDEX "products_inventory_inventory_sku_idx" ON "products" USING btree ("inventory_sku");
  ...
  CREATE INDEX "_products_v_version_inventory_version_inventory_sku_idx" ON "_products_v" USING btree ("version_inventory_sku");
